...
public sealed class SpectreUserInteraction : IUserInteraction
{
  ...
  public SpectreUserInteraction(
    IAnsiConsole console,
    ILogger<SpectreUserInteraction> logger,
  ...
  public void ShowWelcomeBanner(PlatformFacts platformFacts)
  {
    ...
    this.LogTranscript(
      ...
      "BANNER",
      $"Launching onboarding for {platformFacts.OS} ({platformFacts.Arch})"
    );

    var rule = new Rule(
      $"[bold cyan]Onboard Pro[/] — {EscapeMarkup(platformFacts.OS.ToString())} ({EscapeMarkup(platformFacts.Arch.ToString())})"
    );
  ...
  public Task RunStatusAsync(
    string statusMessage,
    Func<IStatusContext, Task> action,
  ...
  public string Ask(string prompt, string? defaultValue = null)
  {
    ...
    var textPrompt = new TextPrompt<string>(EscapeMarkup(prompt)).AllowEmpty();
  ...
  public bool Confirm(string prompt, bool defaultValue = false)
  {
    ...
    var confirmationPrompt = new ConfirmationPrompt(EscapeMarkup(prompt)) { DefaultValue = defaultValue };
  ...
  private sealed class SpectreStatusContext : IStatusContext
  {
    ...
    public SpectreStatusContext(
      SpectreUserInteraction interaction,
