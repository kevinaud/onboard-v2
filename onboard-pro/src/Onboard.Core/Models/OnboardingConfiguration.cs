...
public record OnboardingConfiguration
{
  ...
  /// </summary>
  public string GitCredentialManagerPath { get; init; } =
  ...
  /// <summary>
  /// Gets or sets the resolved Visual Studio Code CLI path on Windows, if available.
  /// </summary>
  public string? VsCodeCliPath { get; set; }
