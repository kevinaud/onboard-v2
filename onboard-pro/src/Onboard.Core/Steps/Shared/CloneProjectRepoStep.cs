...
public class CloneProjectRepoStep : IOnboardingStep
{
    ...
    public Task<bool> ShouldExecuteAsync()
    {
        ...
        userInteraction.WriteWarning($"Path '{paths.RepositoryPath}' exists but is not a Git repository. Move or remove it, then re-run onboarding.");
    ...
    private (string WorkspacePath, string RepositoryPath) ResolvePaths()
    {
        ...
        workspace = NormalizeWorkspacePath(string.IsNullOrWhiteSpace(workspace)
